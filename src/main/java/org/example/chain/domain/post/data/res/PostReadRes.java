...
@Builder
public record PostReadRes(Long postId, String title, String author, String description, List<String> tags, String firstImageUrl, Instant createAt, Long likes, Long views, Long bookmarks, boolean isLiked, boolean isBookmarked) {
